...
--se agrega la relacion del renglon con la RPR
and renprd.aa_rprovision = pr.aa_rprovision and renprd.n_rprovision =  pr.n_rprovision
where c_clase in (990010,560000,790000) and oc.t_ocompra='SPR'
;